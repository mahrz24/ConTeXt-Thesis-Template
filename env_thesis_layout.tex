...
% General captions
\setupcaptions [headstyle=\cap\ss, style=\ss\tfxx, width=\hsize]

\definefloat[rmcfigure][figures][figure]
\setupcaptions[rmcfigure][width=\rightmarginwidth, command=\inright]

\definefloat[lmcfigure][figures][figure]
\setupcaptions[lmcfigure][width=\rightmarginwidth, command=\inleft]
